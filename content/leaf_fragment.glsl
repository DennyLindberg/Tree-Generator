...
void main() 
{
    ...
    vec4 surfaceColorFront = mix(vec4(0.4f, 0.7f, 0.2f, 1.0f), vec4(0.0f, 0.2f, 0.0f, 1.0f), texSample.a);
    vec4 surfaceColorBack = mix(vec4(0.1f, 0.4f, 0.2f, 1.0f), vec4(0.0f, 0.0f, 0.2f, 1.0f), texSample.a);
